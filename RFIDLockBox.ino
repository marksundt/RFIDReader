...
{15,12,131,82,0},  //Card ID //commenting each tag with a description can help you keep track of them
{124,0,18,146,185},  //Button
{1,16,176,193,219}, //bullet
{0,0,0,0,0},//Tag 4
};  
...
ParallaxLCD lcd(10,ROWS,COLS); // desired pin, rows, cols
...
void setup()
{
 ...
 //begin serial communicatons at 9600 baud and print a startup message
  ...
  SERIAL_PORT.println("Please swipe your RFID Tag.");
  lcd.at(0,0,"Swipe your RFID Tag\0");
...
{    
  ...
  if(myRFIDuino.scanForTag(tagData) == true)
  {
    ...
    {        
      ...
      RFIDCardWrite(tagData);
  }    
}//end loop()
 

void RFIDCardWrite(byte tagData[5])
{
     //Clear second line and reposition
     lcd.at(1,0,"                 \0");
     lcd.at(1,0,"\0");
